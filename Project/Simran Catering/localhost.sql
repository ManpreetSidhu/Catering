...
--
-- Host: localhost
-- Generation Time: Jul 01, 2014 at 07:16 PM
...
(NULL, 'simran', 'complaint', 'sno', 1, NULL, 'NO', 'varchar', 14, 14, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(14)', '', '', 'select,insert,update,references', ''),
(NULL, 'simran', 'complaint', 'email', 2, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'simran', 'complaint', 'cmt', 3, NULL, 'NO', 'varchar', 40, 40, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(40)', '', '', 'select,insert,update,references', ''),
(NULL, 'simran', 'complaint', 'cmd', 4, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
(NULL, 'simran', 'enquiry_table', 'name', 1, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'simran', 'enquiry_table', 'address', 2, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'simran', 'enquiry_table', 'title', 3, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'simran', 'enquiry_table', 'city', 4, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'simran', 'enquiry_table', 'country', 5, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'simran', 'enquiry_table', 'contact_person', 6, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'simran', 'enquiry_table', 'telephone', 7, NULL, 'NO', 'bigint', NULL, NULL, 19, 0, NULL, NULL, 'bigint(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'simran', 'enquiry_table', 'email', 8, NULL, 'NO', 'varchar', 40, 40, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(40)', '', '', 'select,insert,update,references', ''),
(NULL, 'simran', 'enquiry_table', 'enqry', 9, NULL, 'NO', 'varchar', 300, 300, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(300)', '', '', 'select,insert,update,references', ''),
(NULL, 'simran', 'enquiry_table', 'enqry_id', 10, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'simran', 'feedback', 'f_name', 1, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'simran', 'feedback', 'l_name', 2, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'simran', 'feedback', 'email', 3, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'simran', 'feedback', 'suggestion', 4, NULL, 'NO', 'varchar', 200, 200, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
(NULL, 'simran', 'feedback', 's_no', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'simran', 'order', 'occ', 1, NULL, 'NO', 'varchar', 15, 15, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'simran', 'order', 'nop', 2, NULL, 'NO', 'varchar', 15, 15, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'simran', 'order', 'venue', 3, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'simran', 'order', 'items', 4, NULL, 'NO', 'varchar', 5, 5, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(5)', '', '', 'select,insert,update,references', ''),
(NULL, 'simran', 'orders', 'name', 1, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'simran', 'orders', 'phno', 2, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'simran', 'orders', 'address', 3, NULL, 'NO', 'varchar', 15, 15, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(15)', '', '', 'select,insert,update,references', ''),
(NULL, 'simran', 'orders', 'city', 4, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
(NULL, 'simran', 'register', 'regno', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
(NULL, 'simran', 'register', 'name', 2, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'simran', 'register', 'phno', 3, NULL, 'NO', 'bigint', NULL, NULL, 19, 0, NULL, NULL, 'bigint(10)', '', '', 'select,insert,update,references', ''),
(NULL, 'simran', 'register', 'address', 4, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'simran', 'register', 'city', 5, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
(NULL, 'simran', 'register', 'email', 6, NULL, 'NO', 'varchar', 30, 30, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(30)', '', '', 'select,insert,update,references', '');
...
('HANDLER_READ_KEY', '0'),
('HANDLER_READ_NEXT', '975'),
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '0'),
('HANDLER_READ_RND_NEXT', '17013'),
('HANDLER_ROLLBACK', '0'),
('HANDLER_SAVEPOINT', '0'),
...
('KEY_BLOCKS_UNUSED', '14332'),
('KEY_BLOCKS_USED', '15'),
('KEY_READ_REQUESTS', '57'),
('KEY_READS', '15'),
...
('THREAD_CACHE_SIZE', '0'),
('LANGUAGE', 'c:\\wamp\\bin\\mysql\\mysql5.1.33\\share\\english\\'),
...
('PROFILING', 'OFF'),
('THREAD_STACK', '196608'),
('PLUGIN_DIR', 'c:\\wamp\\bin\\mysql\\mysql5.1.33\\lib/plugin'),
('OPEN_FILES_LIMIT', '755'),
('KEY_CACHE_DIVISION_LIMIT', '100'),
('EVENT_SCHEDULER', 'OFF'),
('GENERAL_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.1.33\\data\\JAsLeEn.log'),
('SLAVE_COMPRESSED_PROTOCOL', 'OFF'),
('LARGE_FILES_SUPPORT', 'ON'),
('PID_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.1.33\\data\\JAsLeEn.pid'),
...
('SQL_LOG_OFF', 'OFF'),
('SYNC_FRM', 'ON'),
('SLOW_QUERY_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.1.33\\data\\JAsLeEn-slow.log'),
('TIMESTAMP', '1404242176'),
...
(NULL, 'simran', 'PRIMARY', NULL, 'simran', 'enquiry_table', 'enqry_id', 1, NULL, NULL, NULL, NULL),
(NULL, 'simran', 'PRIMARY', NULL, 'simran', 'feedback', 's_no', 1, NULL, NULL, NULL, NULL),
(NULL, 'simran', 'PRIMARY', NULL, 'simran', 'register', 'regno', 1, NULL, NULL, NULL, NULL);
...
(NULL, 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2014-07-02 00:46:16', '2014-07-02 00:46:16', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2014-07-02 00:46:16', '2014-07-02 00:46:16', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2014-07-02 00:46:16', '2014-07-02 00:46:16', NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2014-07-02 00:46:16', '2014-07-02 00:46:16', NULL, NULL, '', '', NULL),
(NULL, 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2014-07-02 00:46:16', '2014-07-02 00:46:16', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2014-07-02 00:46:16', '2014-07-02 00:46:16', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2014-07-02 00:46:16', '2014-07-02 00:46:16', NULL, NULL, '', '', NULL),
...
(NULL, 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2014-07-02 00:46:16', '2014-07-02 00:46:16', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'columns_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 227994731135631359, 4096, 0, '2008-11-14 23:01:31', '2008-11-14 19:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 440, 880, 123848989752688639, 5120, 0, '2008-11-14 23:01:31', '2008-11-14 19:31:32', '2008-11-14 23:01:32', NULL, '', '', NULL),
(NULL, 'mysql', 'event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2008-11-14 23:01:32', '2008-11-14 19:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'func', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162974011515469823, 1024, 0, '2008-11-14 23:01:31', '2008-11-14 19:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'general_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'help_category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 38, 581, 22078, 163536961468891135, 3072, 0, '2008-11-14 23:01:31', '2008-11-14 19:31:34', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'help_keyword', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 450, 197, 88650, 55450570411999231, 16384, 0, '2008-11-14 23:01:32', '2008-11-14 19:31:34', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'help_relation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 975, 9, 8775, 2533274790395903, 16384, 0, '2008-11-14 23:01:32', '2008-11-14 19:31:34', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'help_topic', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 497, 812, 403852, 281474976710655, 20480, 0, '2008-11-14 23:01:31', '2008-11-14 19:31:34', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'host', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 110056715893866495, 2048, 0, '2008-11-14 23:01:31', '2008-11-14 19:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'ndb_binlog_index', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2008-11-14 23:01:32', '2008-11-14 19:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'plugin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162411061562048511, 1024, 0, '2008-11-14 23:01:31', '2008-11-14 19:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'proc', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2008-11-14 23:01:32', '2008-11-14 19:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'procs_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239253730204057599, 4096, 0, '2008-11-14 23:01:32', '2008-11-14 19:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'servers', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 433752939111120895, 1024, 0, '2008-11-14 23:01:31', '2008-11-14 19:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'slow_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'tables_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239535205180768255, 4096, 0, '2008-11-14 23:01:31', '2008-11-14 19:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 1970324836974591, 1024, 0, '2008-11-14 23:01:32', '2008-11-14 19:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone_leap_second', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 3659174697238527, 1024, 0, '2008-11-14 23:01:32', '2008-11-14 19:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone_name', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 55450570411999231, 1024, 0, '2008-11-14 23:01:32', '2008-11-14 19:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone_transition', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 4785074604081151, 1024, 0, '2008-11-14 23:01:32', '2008-11-14 19:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'time_zone_transition_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 10696049115004927, 1024, 0, '2008-11-14 23:01:32', '2008-11-14 19:31:32', NULL, NULL, '', '', NULL),
(NULL, 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 52, 152, 281474976710655, 2048, 48, '2008-11-14 23:01:31', '2009-03-06 18:08:32', NULL, NULL, '', '', NULL),
(NULL, 'simran', 'complaint', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 41, 224, 281474976710655, 1024, 60, '2014-04-16 09:59:30', '2014-05-22 11:25:38', NULL, NULL, '', '', NULL),
(NULL, 'simran', 'enquiry_table', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 17, 85, 1448, 281474976710655, 2048, 0, '2014-04-14 11:57:43', '2014-05-22 10:47:50', NULL, NULL, '', '', NULL),
(NULL, 'simran', 'feedback', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 66, 264, 281474976710655, 2048, 0, '2014-04-14 11:57:43', '2014-05-22 11:15:56', NULL, NULL, '', '', NULL),
(NULL, 'simran', 'order', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2014-04-16 09:27:32', '2014-04-16 09:27:32', NULL, NULL, '', '', NULL),
(NULL, 'simran', 'orders', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 6, 40, 240, 281474976710655, 1024, 0, '2014-04-16 09:43:59', '2014-05-23 12:06:39', NULL, NULL, '', '', NULL),
(NULL, 'simran', 'register', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 10, 68, 920, 281474976710655, 2048, 236, '2014-04-14 11:57:43', '2014-05-23 12:36:20', NULL, NULL, '', '', NULL);
...
('binlog', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50133.0', NULL, NULL, 'MySQL AB', 'This is a pseudo storage engine to represent the binlog in a transaction', 'GPL'),
('MEMORY', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50133.0', NULL, NULL, 'MySQL AB', 'Hash based, stored in memory, useful for temporary tables', 'GPL'),
('MyISAM', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50133.0', NULL, NULL, 'MySQL AB', 'Default engine as of MySQL 3.23 with great performance', 'GPL'),
('MRG_MYISAM', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50133.0', NULL, NULL, 'MySQL AB', 'Collection of identical MyISAM tables', 'GPL'),
('ARCHIVE', '3.0', 'ACTIVE', 'STORAGE ENGINE', '50133.0', NULL, NULL, 'Brian Aker, MySQL AB', 'Archive storage engine', 'GPL'),
('BLACKHOLE', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50133.0', NULL, NULL, 'MySQL AB', '/dev/null storage engine (anything you write to it disappears)', 'GPL'),
('CSV', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50133.0', NULL, NULL, 'Brian Aker, MySQL AB', 'CSV storage engine', 'GPL'),
('InnoDB', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50133.0', NULL, NULL, 'Innobase OY', 'Supports transactions, row-level locking, and foreign keys', 'GPL'),
('partition', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50133.0', NULL, NULL, 'Mikael Ronstrom, MySQL AB', 'Partition Storage Engine Helper', 'GPL'),
('FEDERATED', '1.0', 'DISABLED', 'STORAGE ENGINE', '50133.0', NULL, NULL, 'Patrick Galbraith and Brian Aker, MySQL AB', 'Federated MySQL storage engine', 'GPL');
...
(58, 'root', 'localhost:49726', 'information_schema', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`');
...
(NULL, 'simran', 'latin1', 'latin1_swedish_ci', NULL);
...
(NULL, 'simran', 'enquiry_table', 0, 'simran', 'PRIMARY', 1, 'enqry_id', 'A', 17, NULL, NULL, '', 'BTREE', ''),
(NULL, 'simran', 'feedback', 0, 'simran', 'PRIMARY', 1, 's_no', 'A', 4, NULL, NULL, '', 'BTREE', ''),
(NULL, 'simran', 'register', 0, 'simran', 'PRIMARY', 1, 'regno', 'A', 10, NULL, NULL, '', 'BTREE', '');
...
(NULL, 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2014-07-02 00:46:17', '2014-07-02 00:46:17', NULL, 'utf8_general_ci', NULL, 'max_rows=4560', ''),
...
(NULL, 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2014-07-02 00:46:17', '2014-07-02 00:46:17', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
...
(NULL, 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2014-07-02 00:46:17', '2014-07-02 00:46:17', NULL, 'utf8_general_ci', NULL, 'max_rows=5612', ''),
(NULL, 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2014-07-02 00:46:17', '2014-07-02 00:46:17', NULL, 'utf8_general_ci', NULL, 'max_rows=13025', ''),
(NULL, 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2014-07-02 00:46:17', '2014-07-02 00:46:17', NULL, 'utf8_general_ci', NULL, 'max_rows=23763', ''),
...
(NULL, 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2014-07-02 00:46:17', '2014-07-02 00:46:17', NULL, 'utf8_general_ci', NULL, 'max_rows=588', ''),
...
(NULL, 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2014-07-02 00:46:17', '2014-07-02 00:46:17', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
...
(NULL, 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2014-07-02 00:46:17', '2014-07-02 00:46:17', NULL, 'utf8_general_ci', NULL, 'max_rows=6932', ''),
(NULL, 'mysql', 'columns_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 227994731135631359, 4096, 0, NULL, '2008-11-14 23:01:31', '2008-11-14 19:31:32', NULL, 'utf8_bin', NULL, '', 'Column privileges'),
(NULL, 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 2, 440, 880, 123848989752688639, 5120, 0, NULL, '2008-11-14 23:01:31', '2008-11-14 19:31:32', '2008-11-14 23:01:32', 'utf8_bin', NULL, '', 'Database privileges'),
(NULL, 'mysql', 'event', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2008-11-14 23:01:32', '2008-11-14 19:31:32', NULL, 'utf8_general_ci', NULL, '', 'Events'),
(NULL, 'mysql', 'func', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162974011515469823, 1024, 0, NULL, '2008-11-14 23:01:31', '2008-11-14 19:31:32', NULL, 'utf8_bin', NULL, '', 'User defined functions'),
(NULL, 'mysql', 'general_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 0, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'General log'),
(NULL, 'mysql', 'help_category', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 38, 581, 22078, 163536961468891135, 3072, 0, NULL, '2008-11-14 23:01:31', '2008-11-14 19:31:34', NULL, 'utf8_general_ci', NULL, '', 'help categories'),
(NULL, 'mysql', 'help_keyword', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 450, 197, 88650, 55450570411999231, 16384, 0, NULL, '2008-11-14 23:01:32', '2008-11-14 19:31:34', NULL, 'utf8_general_ci', NULL, '', 'help keywords'),
(NULL, 'mysql', 'help_relation', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 975, 9, 8775, 2533274790395903, 16384, 0, NULL, '2008-11-14 23:01:32', '2008-11-14 19:31:34', NULL, 'utf8_general_ci', NULL, '', 'keyword-topic relation'),
(NULL, 'mysql', 'help_topic', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 497, 812, 403852, 281474976710655, 20480, 0, NULL, '2008-11-14 23:01:31', '2008-11-14 19:31:34', NULL, 'utf8_general_ci', NULL, '', 'help topics'),
(NULL, 'mysql', 'host', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 110056715893866495, 2048, 0, NULL, '2008-11-14 23:01:31', '2008-11-14 19:31:32', NULL, 'utf8_bin', NULL, '', 'Host privileges;  Merged with database privileges'),
(NULL, 'mysql', 'ndb_binlog_index', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2008-11-14 23:01:32', '2008-11-14 19:31:32', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'mysql', 'plugin', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162411061562048511, 1024, 0, NULL, '2008-11-14 23:01:31', '2008-11-14 19:31:32', NULL, 'utf8_bin', NULL, '', 'MySQL plugins'),
(NULL, 'mysql', 'proc', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2008-11-14 23:01:32', '2008-11-14 19:31:32', NULL, 'utf8_general_ci', NULL, '', 'Stored Procedures'),
(NULL, 'mysql', 'procs_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239253730204057599, 4096, 0, NULL, '2008-11-14 23:01:32', '2008-11-14 19:31:32', NULL, 'utf8_bin', NULL, '', 'Procedure privileges'),
(NULL, 'mysql', 'servers', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 433752939111120895, 1024, 0, NULL, '2008-11-14 23:01:31', '2008-11-14 19:31:32', NULL, 'utf8_general_ci', NULL, '', 'MySQL Foreign Servers table'),
(NULL, 'mysql', 'slow_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 0, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'Slow log'),
(NULL, 'mysql', 'tables_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239535205180768255, 4096, 0, NULL, '2008-11-14 23:01:31', '2008-11-14 19:31:32', NULL, 'utf8_bin', NULL, '', 'Table privileges'),
(NULL, 'mysql', 'time_zone', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 1970324836974591, 1024, 0, 1, '2008-11-14 23:01:32', '2008-11-14 19:31:32', NULL, 'utf8_general_ci', NULL, '', 'Time zones'),
(NULL, 'mysql', 'time_zone_leap_second', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 3659174697238527, 1024, 0, NULL, '2008-11-14 23:01:32', '2008-11-14 19:31:32', NULL, 'utf8_general_ci', NULL, '', 'Leap seconds information for time zones'),
(NULL, 'mysql', 'time_zone_name', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 55450570411999231, 1024, 0, NULL, '2008-11-14 23:01:32', '2008-11-14 19:31:32', NULL, 'utf8_general_ci', NULL, '', 'Time zone names'),
(NULL, 'mysql', 'time_zone_transition', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 4785074604081151, 1024, 0, NULL, '2008-11-14 23:01:32', '2008-11-14 19:31:32', NULL, 'utf8_general_ci', NULL, '', 'Time zone transitions'),
(NULL, 'mysql', 'time_zone_transition_type', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 10696049115004927, 1024, 0, NULL, '2008-11-14 23:01:32', '2008-11-14 19:31:32', NULL, 'utf8_general_ci', NULL, '', 'Time zone transition types'),
(NULL, 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 2, 52, 152, 281474976710655, 2048, 48, NULL, '2008-11-14 23:01:31', '2009-03-06 18:08:32', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
(NULL, 'simran', 'complaint', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 4, 41, 224, 281474976710655, 1024, 60, NULL, '2014-04-16 09:59:30', '2014-05-22 11:25:38', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'simran', 'enquiry_table', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 17, 85, 1448, 281474976710655, 2048, 0, 18, '2014-04-14 11:57:43', '2014-05-22 10:47:50', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'simran', 'feedback', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 4, 66, 264, 281474976710655, 2048, 0, 8, '2014-04-14 11:57:43', '2014-05-22 11:15:56', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'simran', 'order', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2014-04-16 09:27:32', '2014-04-16 09:27:32', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'simran', 'orders', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 6, 40, 240, 281474976710655, 1024, 0, NULL, '2014-04-16 09:43:59', '2014-05-23 12:06:39', NULL, 'latin1_swedish_ci', NULL, '', ''),
(NULL, 'simran', 'register', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 10, 68, 920, 281474976710655, 2048, 236, 34, '2014-04-14 11:57:43', '2014-05-23 12:36:20', NULL, 'latin1_swedish_ci', NULL, '', '');
...
(NULL, 'simran', 'PRIMARY', 'simran', 'enquiry_table', 'PRIMARY KEY'),
(NULL, 'simran', 'PRIMARY', 'simran', 'feedback', 'PRIMARY KEY'),
(NULL, 'simran', 'PRIMARY', 'simran', 'register', 'PRIMARY KEY');
...
-- Database: `simran`
--
CREATE DATABASE `simran` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `simran`;
...
INSERT INTO `complaint` (`sno`, `email`, `cmt`, `cmd`) VALUES
('1', 'd@yahoo.com', 'gfbvn', 'vfhj'),
('2', 'gyh@yahoo.com', 'fhjgjh', 'vghjvh'),
('3', 'roopan.deep25@gmail.com', 'sappitttt', 'gggghjjkkliu'),
('4', 'jas@45gmail.com', 'serving', 'not properly');
...
CREATE TABLE IF NOT EXISTS `enquiry_table` (
  ...
  `enqry` varchar(300) NOT NULL,
  `enqry_id` int(10) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`enqry_id`)
...
INSERT INTO `enquiry_table` (`name`, `address`, `title`, `city`, `country`, `contact_person`, `telephone`, `email`, `enqry`, `enqry_id`) VALUES
('orgh', 'gh', 'ert', 'dfgh', 'fghj', 'tyj', 78, 'fgh', 'fgh', 1),
('Sappi', 'VPO Boothgarh Rahon Road', 'rr', 'Ludhiana', '141007', '55555555', 9855455258, 'rschauhan13@gmail.com', '65fff', 2),
('Sappi', 'VPO Boothgarh Rahon Road', 'rr', 'Ludhiana', '141007', '55555555', 9855455258, 'rschauhan13@gmail.com', '65fff', 3),
('Sappi', 'VPO Boothgarh Rahon Road', 'rr', 'Ludhiana', '141007', '55555555', 9855455258, 'rschauhan13@gmail.com', '65fff', 4),
('Sappi', 'VPO Boothgarh Rahon Road', 'rr', 'Ludhiana', '141007', '55555555', 9855455258, 'rschauhan13@gmail.com', '65fff', 5),
('Sappi', 'VPO Boothgarh Rahon Road', 'rr', 'Ludhiana', '141007', '55555555', 9855455258, 'rschauhan13@gmail.com', '65fff', 6),
('Sappi', 'VPO Boothgarh Rahon Road', 'rr', 'Ludhiana', '141007', '55555555', 9855455258, 'rschauhan13@gmail.com', '65fff', 7),
('Sappi', 'VPO Boothgarh Rahon Road', 'rr', 'Ludhiana', '141007', '55555555', 9855455258, 'rschauhan13@gmail.com', '65fff', 8),
('Sappi', 'VPO Boothgarh Rahon Road', 'rr', 'Ludhiana', '141007', '55555555', 9855455258, 'rschauhan13@gmail.com', '65fff', 9),
('Harnoor', 'BBBBBBBBBB', 'GGGGGg', 'hgf', 'HHH', 'hhh', 98765, 'rsfghj', 'ghjkl', 10),
('Amrit', 'amrit', 'ammr', 'hjk', 'hjkl', '98765', 9876, 'rtyu', 'ghjkl;', 11),
('jas', '78-ii', 'party', 'ludhiana', 'india', '7687878798', 6787656876, 'kaurjasleen873@gmail.com', 'huhy', 12),
('ghjj', 'ldh', 'ghkj', 'ldh', 'india', 'bjkh', 36678, 'd@ghhnk,.com', 'nmij', 13),
('rtgh', 'dhg', 'hj', 'y', 'uh', '', 123, 'd', 'hg', 14),
('aaaa', 'aaa', 'aaaaa', 'aaaa', 'aaa', '', 9999, 'aaaa@aaaa.com', 'adxasdcasc', 15),
('aaaa', 'aaa', 'aaaaa', 'aaaa', 'aaa', 'aaa', 9999, 'aaaa@aaaa.com', 'adxasdcasc', 16),
('vgyjuh', 'ludhiana', 'wedding ceremony', 'ldh', 'India', 'harman', 1234567890, 'gill@yahoo.com', 'not gud waiter service', 17);
...
INSERT INTO `feedback` (`f_name`, `l_name`, `email`, `suggestion`, `s_no`) VALUES
('Ranjeet', 'Singh', 'rschauhan13@gmail.com', 'gggggggg', 1),
('gagneet', 'gill', 'gill@yahoo.com', 'jgtydfbhnvfgtbhj  ddjhb', 7),
('uyyui', 'hjhk', '567tuy', 'thh', 2),
('Kanwar', 'Singh', 'kanwarbrar@outlook.com', 'I really love these caterers.', 3);
...
CREATE TABLE IF NOT EXISTS `order` (
  `occ` varchar(15) NOT NULL,
  `nop` varchar(15) NOT NULL,
...
INSERT INTO `orders` (`name`, `phno`, `address`, `city`) VALUES
('$name', '7768654894', '$address', '$city'),
('hj', '9876543210', 'hj', 'hj'),
('cvf', '9876543210', 'gfghg', 'fbghn'),
('party', '9876543210', 'home', '6'),
('wedding', '100', 'barnala', 'stators'),
('ggh', 'hhh', 'hhh', 'hh');
...
INSERT INTO `register` (`regno`, `name`, `phno`, `address`, `city`, `email`) VALUES
(4, 'Ranjeet Singh', 9855455258, 'VPO Boothgarh Rahon Road', 'Ludhiana', 'rschauhan13@gmail.com'),
(6, 'dd', 9855455258, 'dd', 'dd', 'mani@gmail.com'),
(7, 'dd', 9855455258, 'dd', 'dd', 'mani@gmail.com'),
(8, 'dd', 9855455258, 'dd', 'dd', 'mani@gmail.com'),
(9, 'dd', 9855455258, 'dd', 'dd', 'mani@gmail.com'),
(33, 'fgh', 987654, 'hjhg6h789h', 'nhjkj', 'hh@gmail.com'),
(32, 'gg', 0, 'hh', 'hh', 'hh@gmail.com'),
(31, 'hjhj', 0, 'jj', 'jj', 'jasleenkaur1212@gmail.com'),
(30, 'njnj', 0, 'jjj', 'jj', 'jasleenkaur1212@gmail.com'),
(29, 'g', 7, 'hj', 'hj', 'hh@gmail.com');
